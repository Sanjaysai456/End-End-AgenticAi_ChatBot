...
2. "web_search" - The user is asking a factual question or something that requires searching the web for real-time information (e.g., weather, current events, recent data).
3. "basic" - The user is just chatting, greeting, or asking general questions that don't require external tools or news.

Output your response strictly as a JSON object with the following keys:
- "intent": string (must be one of "ai_news", "web_search", "basic")
